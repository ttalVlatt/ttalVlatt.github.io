...
```{=typst}
    ...
    #h(0.6fr) #fa-icon("globe") #link("https://capaldi.info")[Website] #h(0.2fr) #fa-icon("envelope") #link("mailto:matt.capaldi@outlook.com")[Email Me] #h(0.2fr) #fa-icon("phone") #link("tel:401-601-2069")[Call Me] #h(0.2fr) #fa-icon("google-scholar") #link("https://scholar.google.com/citations?user=PHk--sIAAAAJ&hl=en")[Google Scholar] #h(0.2fr) #fa-icon("orcid") #link("https://orcid.org/0000-0002-5664-3414")[ORCiD] #h(0.6fr)
    ...
    #block(inset: (left: 1in, right: 0in))[
      ...
      *1.* The Route to Graduation: An Exploration of the Association Between Transit Stop Proximity and Pell Recipient Completion Rates at US Commuter Colleges \ 
      *2.* The Route to Retention: A Propensity Score and Instrumental Variable Analysis of
Transit Stop Proximity and Urban US Commuter College Retention Rates \ 
      *3.* Local Access Matters: A Structural Equation Modeling Exploration of the Association
Between Transport Disadvantage and College Enrollment in New Jersey \ 
    ...
    #block(inset: (left: 1in, right: 0in))[//#set par(hanging-indent: 0.5in)
      *Final Project:* 
      // #block(inset: (left: 0.5in))[
      A Time and Place for (Sustainable) Campus Planning: Using Structural Topic Modeling to Explore Variations in Planning Priorities at Large US Public Colleges \
      // ]
    ]
