...
```{=typst}
    ...
    #h(0.6fr) #fa-icon("globe") #link("https://capaldi.info")[Website] #h(0.2fr) #fa-icon("envelope") #link("mailto:matt.capaldi@outlook.com")[Email Me] #h(0.2fr) #fa-icon("phone") #link("tel:401-601-2069")[Call Me] #h(0.2fr) #fa-icon("stack-overflow") #link("https://stackoverflow.com/users/21152968/ttalvlatt")[StackOverflow] #h(0.2fr) #fa-icon("github") #link("https://github.com/ttalVlatt")[GitHub] #h(0.6fr)
   ...
   // - Data collection, wrangling, visualization, & analysis leading to multiple publications #super[#link("https://doi.org/10.1177/00915521241238753")[1,]#link("https://partnershipfcc.org/publications/adequacy/")[ 2]]
    ...
    - Merged data and created tables and visualizations for a #link("https://partnershipfcc.org/publications/adequacy/")[report targeted at state policy makers]
    - TA for "The R Class" including majority of teaching in 2024 after instructor's resignation
    #h(0.5in) - Refreshed the #link("https://capaldi.info/7916/")[course website] adding #link("https://capaldi.info/7916/09-wrangle-iv.html")[a new lesson] connecting tidyverse and SQL concepts
    - Provided 1:1 tutoring on Stata and IPEDS data wrangling to a new graduate assistant
]
    ...
    *Residence Hall Coordinator* -- University of Missouri #h(1fr) _July 2020 -- May 2021_ \
    ...
    - Supervised 16 student staff members and provided crisis response to 3242 residents 
    ...
    *Student Ambassador* --  University of Birmingham #h(1fr) _January 2015 -- June 2018_ \
    ...
    Intermediate PostgreSQL -- University of Michigan #h(1fr) _January 2025 (Expected)_
    ...
    #link("https://capaldi.info/cv.pdf")[Curriculum Vitae] -- Complete record of academic and research activity
